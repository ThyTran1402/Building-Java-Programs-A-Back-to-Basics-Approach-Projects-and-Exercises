...
public class ArraysAndArrayLists 
{
    public static void main(String[] args) 
    {
        ...
        String [] favSportsTeams = {"Heat", "Dolphins", "Marlins", "Panthers", "Hurricanes"};
        ...
        for(int i = 0; i < favNumbers.length; ++i){
            favNumbers[i] = scanner.nextInt();
        }
        Arrays.sort(favNumbers); //I use ctrl + spacebar to import the libraries.
        System.out.println("Here are your favorite numbers:");
        for(int i : favNumbers){
            System.out.println(i);
        }
        for(String z: favSportTeams)
